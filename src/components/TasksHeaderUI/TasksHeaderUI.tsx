...
function TasksHeaderUI({ expanded, handleTaskOpenToggle }: TasksHeaderUIProps) {
   return (
      <div
         className={`relative w-fit flex justify-center items-center ml-4 mt-3 cursor-pointer text-white border rounded-full pr-2 hover:pr-2 hover:opacity-100 group ${
